...
function Canvas({ isDarkMode, initialNodes = [], initialEdges = [], onStateChange }: CanvasProps) {
  ...
  const handleDemo = useCallback(() => {
    ...
    const demoEdges: Edge[] = [
      ...
      { id: 'e-lb-apigw', source: 'demo-lb', target: 'demo-apigw', sourceHandle: 'bottom-source', targetHandle: 'top-target', data: { connectionType: 'sync', protocol: 'http' }, style: { stroke: isDarkMode ? '#d1d5db' : '#b1b1b7', strokeWidth: 2 }, type: 'default', animated: true },
